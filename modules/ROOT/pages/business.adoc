...
* Firstly, the UML must follow certain xref:../pages/uml/conceptual-model-conventions..adoc[conventions]
...
#graphic of the high-level process#

To understand the technical process in more depth, see the xref:technical.adoc[Technical Overview], as well as the xref:ePO_Arch_Design.adoc[eProcurement Ontology Architecture and Formalisation Specifications].
