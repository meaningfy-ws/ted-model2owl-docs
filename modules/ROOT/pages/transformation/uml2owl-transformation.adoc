...
The remainder of this document comprises four sections covering major UML topics. The section xref:transformation/transf-rules1.adoc#sec:tran-rules[Classes and Attributes] treats classes and attributes. The second section deals with the   xref:transformation/transf-rules2.adoc[associations, dependencies and generalisations]. The third section  describes the xref:transformation/transf-rules3.adoc[transformation rules] i.e., how the data types and enumerations should be transformed and finally, the fourth and final section provides xref:transformation/transf-rules4.adoc[transformation rules applicable to all UML elements], concerning comments, labels and notes.
