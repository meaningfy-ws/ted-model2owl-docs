:doctitle: Transformation of UML datatypes
...
The UML primitive type defines a predefined datatype without any substructure. The UML specification https://www.omg.org/spec/UML/2.5.1[uml 2.5] predefines five primitive types: String, Integer, Boolean, UnlimitedNatural and Real. Here we extended those to the list provided in <<tab:type-mapping>>.
...
The UML structured datatype https://www.omg.org/spec/UML/2.5.1[uml 2.5] has attributes and is used to define complex data types. The structured datatypes should be treated as classes.
...
UML Enumerations https://www.omg.org/spec/UML/2.5.1[uml 2.5] are kinds of datatypes, whose values correspond to one of user-defined literals. They should be transformed into https://www.w3.org/2004/02/skos/specs[SKOS] concept schemes comprising the concepts corresponding to enumerated items.
