...
This part of the *model2owl* project documentation describes _the conventions that the UML conceptual model should adhere to_ so that the tools provided within the *model2owl* project generate the best possible derived artefacts i.e., the most complete and correct OWL ontologies and SHACL shapes.
