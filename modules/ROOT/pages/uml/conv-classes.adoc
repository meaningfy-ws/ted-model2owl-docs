...
Classes may use the _\<<abstract>> stereotype_. It means that no instances are allowed of this class in the datasets. This is not covered by the https://www.w3.org/2012/pdf/REC-owl2-overview-20121211.pdf[OWL 2] but can be expressed in https://www.w3.org/TR/shacl/[SHACL data shapes].
