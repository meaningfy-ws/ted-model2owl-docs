...
To use model2owl without installing or executing anything locally, the online https://github.com/meaningfy-ws/model2owl-boilerplate[model2owl boilerplate utility] has been created. The instructions on how to use it are given in the repositories README.md file as well as below.
