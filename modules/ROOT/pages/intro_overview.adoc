...
https://github.com/OP-TED/model2owl[model2owl] is a project which can be implemented in different model cases to generate a semantic data specification. In the case of the ePO, it is a specific implementation used to generate a semantic data specification from the ePO conceptual model. 
