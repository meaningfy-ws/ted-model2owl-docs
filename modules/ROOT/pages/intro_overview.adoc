...
https://github.com/OP-TED/model2owl[model2owl] is a project, which, in the case of the ePO, is a specific implementation which, in terms , is used to generate a semantic data specification from the ePO conceptual model. An open source https://github.com/OP-TED/model2owl[reference implementation] is available here.

model2owl is a tool that takes the UML as input converts it automatically into produces 
